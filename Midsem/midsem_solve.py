...
M5 = [[0.2, -5, 3, 0.4, 0],
     ...
     [3, 0.8, 2, -0.4, 3],
     [0.5, 3, 2, 0.4, 1]]
x1 = LUSolve(M1,[[1],[0],[0],[0],[0]])
x2 = LUSolve(M2,[[0],[1],[0],[0],[0]])
x3 = LUSolve(M3,[[0],[0],[1],[0],[0]]) 
x4 = LUSolve(M4,[[0],[0],[0],[1],[0]])
x5 = LUSolve(M5,[[0],[0],[0],[0],[1]])  
...
--------Question 3---------
[[[-0.7079491478066469], [2.5314333612741007], [2.4311958647666922], [0.9665758591785414], [-3.9022771723945238]], [[-0.19343159169227886], [0.31014249790444265], [0.27946586569805326], [0.05771514389494271], [-0.2941347676259662]], [[0.021689019279128387], [0.3654652137468567], [0.2861483654652136], [0.0505553227158424], [-0.2899203688181055]], [[0.27341203315637475], [-0.12992455993294275], [0.13161264785321758], [-0.14101355127130483], [0.44885675700847544]], [[0.7815264971593533], [-2.875104777870915], [-2.678937319549222], [-0.7011385861972617], [4.233840923907981]]]
